...
Where the true score $T$ is defined as the expectation of the hypothetical distribution of observed scores if it were possible to obtain an infinite number of independent repeated measures, which is sometimes called the *propensity definition* of the true score:
